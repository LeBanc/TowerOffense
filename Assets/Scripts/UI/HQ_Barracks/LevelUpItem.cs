...
/// <summary>
/// LevelUpItem class defines a LevelUp item
/// LevelUpItem requires the GameObject to have a SelectedButton component
/// </summary>
...
public class LevelUpItem : MonoBehaviour
{
    ...
    // Events
    public delegate void LevelUpItemEventHandler();
    public event LevelUpItemEventHandler OnSelection;
    ...
    /// <summary>
    /// SelectButton method selects the item and its associated SelectedButton
    /// </summary>
